...
@section('content')
                ...
                <div class="ltn__slider-11-img-slide-arrow-inner">
                    <div class="ltn__slider-11-img-slide-arrow-active">
                        <div class="image-slide-item">
                            <img src="{{ asset('landing') }}/img/slider/61.jpg" alt="Flower Image">
                        </div>
                        <div class="image-slide-item">
                            <img src="{{ asset('landing') }}/img/slider/62.jpg" alt="Flower Image">
                        </div>
                        <div class="image-slide-item">
                            <img src="{{ asset('landing') }}/img/slider/63.jpg" alt="Flower Image">
                        </div>
                        <div class="image-slide-item">
                            <img src="{{ asset('landing') }}/img/slider/64.jpg" alt="Flower Image">
                        </div>
                    </div>
    ...
    <!-- BOOKING FORM START -->
    <div class="ltn__car-dealer-form-area pb-115--- mt-60">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                        ...
                                        <div
                                            ...
                                            <div class="btn-wrapper mt-0 text-center">
                                                ...
                                                <a href="shop-right-sidebar.html"
                                                    class="btn theme-btn-1 btn-effect-1 text-uppercase">Find Now</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <!-- ABOUT US AREA START -->
    <div class="ltn__about-us-area pt-115">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        ...
                        <div class="ltn__animation-pulse2 mt-30 text-center">
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="ltn__upcoming-project-img">
                                    <img src="{{ asset('landing') }}/img/product-3/3.jpg" alt="#">
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__upcoming-project-item">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="ltn__upcoming-project-img">
                                    <img src="{{ asset('landing') }}/img/product-3/2.jpg" alt="#">
                                </div>
                            </div>
                            <div class="col-lg-5 section-bg-1">
                                <div class="ltn__upcoming-project-info ltn__menu-widget">
                ...
                <div class="col-lg-12">
                    <div class="ltn__upcoming-project-item">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="ltn__upcoming-project-img">
                                    <img src="{{ asset('landing') }}/img/product-3/7.jpg" alt="#">
                                </div>
                            </div>
                            <div class="col-lg-5 section-bg-1">
                                <div class="ltn__upcoming-project-info ltn__menu-widget">
                ...
                <div class="col-lg-12">
                    <div class="ltn__neighbour-tab-wrap">
                        <div class="ltn__tab-menu ltn__tab-menu-3--- ltn__tab-menu-4 ltn__tab-menu-top-right-- text-uppercase--- text-center">
                            <div class="nav">
                                <a class="active show" data-bs-toggle="tab" href="#liton_tab_4_1"><img src="{{ asset('landing') }}/img/neighbour/1.jpg" alt="#"></a>
                                <a data-bs-toggle="tab" href="#liton_tab_4_2" class=""><img src="{{ asset('landing') }}/img/neighbour/2.jpg" alt="#"></a>
                                <a data-bs-toggle="tab" href="#liton_tab_4_3" class=""><img src="{{ asset('landing') }}/img/neighbour/3.jpg" alt="#"></a>
                            </div>
                        </div>
                        <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="neighbour-apartments-img">
                                                <img src="{{ asset('landing') }}/img/neighbour/1.jpg" alt="#">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                            ...
                            <div class="tab-pane fade" id="liton_tab_4_2">
                                <div class="ltn__neighbour-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="neighbour-apartments-img">
                                                <img src="{{ asset('landing') }}/img/neighbour/2.jpg" alt="#">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="ltn__search-by-place-item neighbour-apartments-item">
                            ...
                            <div class="tab-pane fade" id="liton_tab_4_3">
                                <div class="ltn__neighbour-tab-content-inner">
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="neighbour-apartments-img">
                                                <img src="{{ asset('landing') }}/img/neighbour/3.jpg" alt="#">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="ltn__search-by-place-item neighbour-apartments-item">
                            ...
                            <div class="col-lg-6">
                                <div id="accordion_2">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="faq-item-2-2" class="show--- collapse" data-bs-parent="#accordion_2">
                                            <div class="card-body">
                                                <div class="ltn__video-img alignleft">
                                                    <img src="{{ asset('landing') }}/img/bg/17.jpg" alt="video popup bg image">
