...
<html lang="en" data-bs-theme="light" data-menu-color="dark" data-topbar-color="light">
    <head>
        <meta charset="utf-8" />
        <title>Carousel | Drezoc - Responsive Bootstrap 5 Admin Dashboard</title>
                    ...
                    <div class="topbar">
                        ...
                        <ul class="topbar-menu d-flex align-items-center gap-2">
                            ...
                            <li class="dropdown d-none d-md-inline-block">
                                <a class="nav-link dropdown-toggle waves-effect waves-dark arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ asset('admin') }}assets/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1" height="18">
                                </a>
                                        ...
                                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-1.jpg" alt="First slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-2.jpg" alt="Second slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-3.jpg" alt="Third slide">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-4.jpg" alt="First slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-1.jpg" alt="Second slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-2.jpg" alt="Third slide">
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="{{ asset('admin') }}assets/images/media/img-1.jpg" alt="..." class="d-block img-fluid">
                                                ...
                                                <div class="carousel-item">
                                                    <img src="{{ asset('admin') }}assets/images/media/img-3.jpg" alt="..." class="d-block img-fluid">
                                                    <div class="carousel-caption d-none d-md-block">
                                                ...
                                                <div class="carousel-item">
                                                    <img src="{{ asset('admin') }}assets/images/media/img-2.jpg" alt="..." class="d-block img-fluid">
                                                    <div class="carousel-caption d-none d-md-block">
                                        ...
                                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                ...
                                                <div class="carousel-item" data-bs-interval="2000">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-5.jpg" alt="Third slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="{{ asset('admin') }}assets/images/media/img-1.jpg" alt="Third slide">
                                                </div>
